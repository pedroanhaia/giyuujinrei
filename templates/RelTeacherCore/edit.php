...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $relTeacherCore->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $relTeacherCore->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="relTeacherCore form content">
            ...
            <fieldset>
                <legend><?= __('Edit Rel Teacher Core') ?></legend>
                <?php
