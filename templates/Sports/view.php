<div class="col-md-12 content">
	<div class="row">
		<div class="col-12">
			<?= $role >= C_RoleTudo ? $this->Form->postLink(__('Excluir esporte'), ['action' => 'delete', $sport->id], ['confirm' => __('Você confirma a exclusão deste item?', $sport->id), 'class' => 'btn btn-danger text-white float-right m-r-5']) : '' ?>
			<?= $role >= C_RoleTudo ? $this->Html->link(__('Alterar esporte'), ['action' => 'edit', $sport->id], ['class' => 'btn btn-warning text-white float-right m-r-5']) : '' ?>
