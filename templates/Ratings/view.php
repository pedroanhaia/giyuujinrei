<div class="col-md-12 content">
	<div class="row">
		<div class="col-12">
			<?= $this->Form->postLink(__('Excluir área'), ['action' => 'delete', $rating->id], ['confirm' => __('Você confirma a exclusão deste item?', $rating->id), 'class' => 'btn btn-danger text-white float-right m-r-5']) ?>
			<?= $this->Html->link(__('Alterar área'), ['action' => 'edit', $rating->id], ['class' => 'btn btn-warning text-white float-right m-r-5']) ?>
